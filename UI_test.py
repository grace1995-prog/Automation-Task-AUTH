tgifrom selenium import webdriver
...
driver.find_element(By.XPATH, "//button[normalize-space()='Login']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//a[@class='active']//div[@class='menu-icon'] ").click()
time.sleep(5)
driver.find_element(By.XPATH, "//div[@class='deznav']//ul[1]").click()
time.sleep(5)
driver.find_element(By.XPATH, "//div[@class='deznav']//ul[1]//li[1]").click()
time.sleep(5)
driver.find_element(By.XPATH, "//li[@class='active mm-active']").click()
time.sleep(5)
driver.find_element(By.XPATH, "//div[@class='deznav']//ul[1]//li[1]").click()
time.sleep(5)
